...
/**
  ...
  date specification into \code
  Date
  \endcode objects
*/
SWIFT_CLASS("_TtC7FeedKit20ISO8601DateFormatter")
@interface ISO8601DateFormatter : NSDateFormatter
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull dateFormats;
...
/**
  The actual engine behind the \code
  FeedKit
  \endcode framework. \code
  Parser
  \endcode handles
  the parsing of RSS and Atom feeds. It is an \code
  XMLParserDelegate
  \endcode of
  itself.
*/
SWIFT_CLASS("_TtC7FeedKit6Parser")
@interface Parser : NSXMLParser <NSXMLParserDelegate>
/**
...
@property (nonatomic, strong) NSError * _Nullable parsingError;
@end


@interface Parser (SWIFT_EXTENSION(FeedKit))
...
/**
  ...
  \endcode objects
*/
SWIFT_CLASS("_TtC7FeedKit20RFC3339DateFormatter")
@interface RFC3339DateFormatter : NSDateFormatter
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull dateFormats;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (NSDate * _Nullable)dateFromString:(NSString * _Nonnull)string;
...
/**
  ...
  \endcode objects
*/
SWIFT_CLASS("_TtC7FeedKit19RFC822DateFormatter")
@interface RFC822DateFormatter : NSDateFormatter
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull dateFormats;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (NSDate * _Nullable)dateFromString:(NSString * _Nonnull)string;
